...
const Skills = () => {
     return (
          <div>
               <section data-aos="zoom-in-down" data-aos-delay="500" className="bg-gray-100 lg:bg-white  dark:text-gray-800 mt-5">
               ...
               <section data-aos="fade-down"
                    ...
                    data-aos-duration="2000" className="bg-gray-400 mt-6  p-5">
